...
const htmlModalContent = ({ id, title, description, url }) => {
    ...
    <div id=${id}>
    ${url ?
            `<img width=100% height="100px" style="object-fit:cover; object-position:center;" src=${url} alt="card image cap" class='img-fluid place__holder__image mb-3'/>`
            : `<img width='100%' height="100px" style="object-fit:cover; object-position:center;"  src="https://reactnativecode.com/wp-content/uploads/2018/02/Default_Image_Thumbnail.png" alt="card image cap" class="img-fluid place__holder__image mb-3" />`
        }
    </div>
